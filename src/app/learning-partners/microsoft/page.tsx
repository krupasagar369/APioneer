...
const title = "Microsoft Learn Certifications — APIONEER";
const description = "Official Microsoft Learn modules, learning paths and certification tracks, delivered by APIONEER.";
  ...
  return (
    <>
      ...
      <section className="section-y container-x">
        <SectionHeading eyebrow="Live catalogue" title="Courses & Modules" />
        <MicrosoftCatalog />
      </section>
